      ...
      <aside  class="floor-banner-wrap-inner common-flex-box">
        <figure  class="floor-banner-cover">
          <img
            ...
            alt="广告位图片"
            class="floor-banner-poster"
          />
        </figure>
      </aside>
      <!---->
      <aside  class="list-wrap common-flex-box flex-three">
        <section v-for="(ele, index) in item.skuInfo" :key="index" class="sku-item-normal-box flex-item">
...
.home-box .flex-four .flex-item[data-v-fab33ed0] .item-price, .home-box .flex-three .flex-item .item-price {
    font-size: .6rem;
}
